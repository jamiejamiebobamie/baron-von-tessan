...
export default class AnimateDrawing extends DisplayDrawingContainer{
    ...
    eraseFromVerticesAndAddToInk(){
        for (let i = 0; i < this.vertices.length; i++ ){
            if ( this.p.mouseX > this.vertices[i].x*this.lengthOfDrawingSquare-this.lengthOfDrawingSquare*.01
                && this.p.mouseX < this.vertices[i].x*this.lengthOfDrawingSquare+this.lengthOfDrawingSquare*.01
                && this.p.mouseY > this.vertices[i].y*this.lengthOfDrawingSquare-this.lengthOfDrawingSquare*.01
                && this.p.mouseY < this.vertices[i].y*this.lengthOfDrawingSquare+this.lengthOfDrawingSquare*.01 ){
