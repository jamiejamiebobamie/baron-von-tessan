...
export default class EnterDescriptionView {
  ...
  setUI(p, w, h, REACT_APP, windowResized, previousUI, changeView) {
    ...
    wildcard = { shrinkAmountWidth: 1, shrinkAmountHeight: 0.5 };
    parameters = {
      p: p,
      windowWidth: w,
      windowHeight: h,
    ...
    wildcard = { shrinkAmountWidth: 0.95, shrinkAmountHeight: 1 };
    parameters = {
      p: p,
      windowWidth: w,
      windowHeight: h,
    ...
    wildcard = { shrinkAmountWidth: 0.9, shrinkAmountHeight: 1.5 };
    parameters = {
      p: p,
      windowWidth: w,
      windowHeight: h,
    ...
    wildcard = { shrinkAmountWidth: 0.95, shrinkAmountHeight: 1.8 };
    parameters = {
      p: p,
      windowWidth: w,
      windowHeight: h,
    ...
    wildcard = { shrinkAmountWidth: 0.95, shrinkAmountHeight: 0.95 };
    parameters = {
      p: p,
      windowWidth: w,
      windowHeight: h,
    ...
    let keyboardButton;
    wildcard = { shrinkAmountWidth: 0.9, shrinkAmountHeight: 0.8 };
    ...
    wildcard = { fontSize: backButton.width / 10, numberOfLines: 0.8 };
    parameters = {
      p: p,
      objectToMirror: backButton,
      x: x,
      y: y,
      width: width,
      height: height,
      mouseClickfunc: returnToPreviousView,
      wildcard: wildcard
    };
    ...
    parameters = {
      p: p,
      objectToMirror: submitButton,
      x: x,
      y: y,
      width: width,
      height: height,
      mouseClickfunc: submitDescription,
      wildcard: wildcard
    };
    ...
    wildcard = {
      fontSize: input.width / 25,
      REACT_APP: REACT_APP,
      numberOfLines: 1
    };
    parameters = {
      p: p,
      objectToMirror: input,
      x: x,
      y: y,
      width: width,
      height: height,
    ...
    if (previousUI) {
      if (previousUI.drawing) {
        ...
        strokeIndex = previousUI.drawing.submittedStrokeIndex
          ? previousUI.drawing.submittedStrokeIndex
          : 0;
