...
class App extends Component {
    ...
    fetchDrawings(number, shouldFetchLikedDrawings, firstCall){
        ...
        if (shouldFetchLikedDrawings)
            url = "https://baron-von-tessan-backend.herokuapp.com/api/v1/liked-drawings/"+number
        else
            url = "https://baron-von-tessan-backend.herokuapp.com/api/v1/random-drawings/"+number
        if (firstCall)
            url = "initialize first with simulated data"
